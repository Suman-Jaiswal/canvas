...
bgFolder.add(bgColor, 'a', 0, 0.1); // Objects
...
var _Object = /*#__PURE__*/function () {
  ...
  _createClass(Object, [{
    ...
    value: function draw() {
      ...
      c.strokeStyle = "hsl(".concat(Math.abs(strokeColor.h * Math.sin(this.increment)), ",").concat(strokeColor.s, "%,").concat(strokeColor.l, "%)");
      c.stroke();
      c.closePath();
    }
  }, {
...
function init() {
  ...
  for (var i = 0; i < 1; i++) {
    objects.push(new _Object('black'));
  }
} // Animation Loop
