...
var colors = ['green', '#900C3E', 'blue', '#FF5733', '#FFC300']; // Event Listeners
...
function Object(x, y, radius, color) {
  ...
  this.velocity = 0.04;
  this.amplitude = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(50, 120);
  this.lastMouse = {
    x: x,
    y: y
  };
  ...
  this.update = function () {
    ...
    _this.x = _this.lastMouse.x + Math.cos(_this.radians) * _this.amplitude;
    _this.y = _this.lastMouse.y + Math.sin(_this.radians) * _this.amplitude;
...
function animate() {
  ...
  c.fillRect(0, 0, canvas.width, canvas.height); // c.fillText('HTML CANVAS BOILERPLATE', mouse.x, mouse.y)
